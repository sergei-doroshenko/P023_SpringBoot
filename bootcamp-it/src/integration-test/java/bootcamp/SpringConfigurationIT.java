...
public class SpringConfigurationIT {
    ...
    public void deploy() throws Throwable {
        ...
        servicesDeployer.deployService(applicationName, mysqlSvc, /*"p-mysql"*/"cleardb", /*"100mb"*/"spark")
                // <1>
                .then(
                        applicationDeployer.deployApplication(jar, applicationName, env, timeout, mysqlSvc)
                ) // <2>
                .block(); // <3>
